...
#setwd("/home/rafaela/Documents/PUC/2022.1/TFC/codigos/sertao")
setwd("C:\\Users\\Rafaela\\Downloads\\2022\\TFC\\codigos eol\\sertao\\SOM")
...
write.csv(clust1, "sertao_clust1_som_12K_16n.csv")
write.csv(clust2, "sertao_clust2_som_12K_16n.csv")
write.csv(clust3, "sertao_clust3_som_12K_16n.csv")
write.csv(clust4, "sertao_clust4_som_12K_16n.csv")
write.csv(clust5, "sertao_clust5_som_12K_16n.csv")
write.csv(clust6, "sertao_clust6_som_12K_16n.csv")
write.csv(clust7, "sertao_clust7_som_12K_16n.csv")
write.csv(clust8, "sertao_clust8_som_12K_16n.csv")
write.csv(clust9, "sertao_clust9_som_12K_16n.csv")
write.csv(clust10, "sertao_clust10_som_12K_16n.csv")
write.csv(clust11, "sertao_clust11_som_12K_16n.csv")
write.csv(clust12, "sertao_clust12_som_12K_16n.csv")
...
write.csv(df,"porMes_sertao_som_12K_16n.csv", row.names = FALSE)
