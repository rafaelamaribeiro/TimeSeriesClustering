...
sertao <- read.csv2("SERTAO_BA_UCT.csv")
...
PlotapodiBoxplot <- ggplot(sertao_pos, 
...
df
write.csv(df,"porMes_sertao.csv", row.names = FALSE)
write.csv(aa1,"profile1_sertao.csv", row.names = FALSE)
write.csv(aa2,"profile2_sertao.csv", row.names = FALSE)
write.csv(aa3,"profile3_sertao.csv", row.names = FALSE)
write.csv(aa4,"profile4_sertao.csv", row.names = FALSE)
write.csv(aa5,"profile5_sertao.csv", row.names = FALSE)
write.csv(aa6,"profile6_sertao.csv", row.names = FALSE)
write.csv(aa7,"profile7_sertao.csv", row.names = FALSE)
write.csv(aa8,"profile8_sertao.csv", row.names = FALSE)
write.csv(aa9,"profile9_sertao.csv", row.names = FALSE)
write.csv(aa10,"profile10_sertao.csv", row.names = FALSE)
