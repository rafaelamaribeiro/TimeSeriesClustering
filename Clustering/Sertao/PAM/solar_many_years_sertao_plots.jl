...
#cd("/home/rafaela/Documents/PUC/IC/Global Horizontal Irradaytion/dados/Sertao/")
path = pwd()
...
aa1 = CSV.read("profile1_sertao_pam_3K.csv", DataFrame)
aa2 = CSV.read("profile2_sertao_pam_3K.csv", DataFrame)
aa3 = CSV.read("profile3_sertao_pam_3K.csv", DataFrame)

df_por_mes = CSV.read("porMes_sertao_pam_3K.csv", DataFrame)

cluster = CSV.read("cluster_sertao_pam_3K.csv", DataFrame)
cluster = cluster.x
...
savefig(plot1, "K3-K1-Sertão-Sol.png")
savefig(plot2, "K3-K2-Sertao-Sol.png")
savefig(plot3, "K3-K3-Sertao-Sol.png")
...
savefig(p, "chosen-days-k10-Sertão-Sols.png")
