...
df
write.csv(df,"porMes_sertao_k_means_3K.csv", row.names = FALSE)
write.csv(aa1,"profile1_sertao_k_means_3K.csv", row.names = FALSE)
write.csv(aa2,"profile2_sertao_k_means_3K.csv", row.names = FALSE)
write.csv(aa3,"profile3_sertao_k_means_3K.csv", row.names = FALSE)
write.csv(means.res$cluster, "cluster_sertao_k_means_3K.csv", row.names = FALSE)
