...
#setwd("/home/rafaela/Documents/PUC/2022.1/TFC/codigos/Eugenia")
setwd("C:\\Users\\Rafaela\\Downloads\\2022\\TFC\\codigos eol\\Eugenia")
...
write.csv(clust1, "eugenia_clust1_som_12K_16n.csv")
write.csv(clust2, "eugenia_clust2_som_12K_16n.csv")
write.csv(clust3, "eugenia_clust3_som_12K_16n.csv")
write.csv(clust4, "eugenia_clust4_som_12K_16n.csv")
write.csv(clust5, "eugenia_clust5_som_12K_16n.csv")
write.csv(clust6, "eugenia_clust6_som_12K_16n.csv")
write.csv(clust7, "eugenia_clust7_som_12K_16n.csv")
write.csv(clust8, "eugenia_clust8_som_12K_16n.csv")
write.csv(clust9, "eugenia_clust9_som_12K_16n.csv")
write.csv(clust10, "eugenia_clust10_som_12K_16n.csv")
write.csv(clust11, "eugenia_clust11_som_12K_16n.csv")
write.csv(clust12, "eugenia_clust12_som_12K_16n.csv")
...
write.csv(df,"porMes_eugenia_som_12K_16n.csv", row.names = FALSE)
