...
setwd("C:\\Users\\Rafaela\\Downloads\\2022\\TFC\\codigos eol\\Fernando\\SOM")
...
que_cluster <- read.csv("2k_som.csv")
...
write.csv(clust1, "fernando_clust1_som.csv")
write.csv(clust2, "fernando_clust2_som.csv")
...
write.csv(df,"porMes_fernando_som20.csv", row.names = FALSE)