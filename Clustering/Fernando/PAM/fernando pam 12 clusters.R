...
#fernando$dates_new <- as.POSIXct(fernando$dates_UCT, format = "%Y/%m/%d %H:%M")
...
#library(dplyr)
#fernando_pos <- filter(fernando, FERNANDO_RN>0.1)
#length(fernando_pos$FERNANDO_RN)
...
set.seed(321)
pam.res = pam(d, 12, diss = TRUE) #2

#pam.res$clustering[1]

summary(pam.res)

dates <- unique(fernando$dates_new)
tail(dates)
months <- month(dates)
length(months)
...
df
write.csv(df,"porMes_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa1,"profile1_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa2,"profile2_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa3,"profile3_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa4,"profile4_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa5,"profile5_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa6,"profile6_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa7,"profile7_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa8,"profile8_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa9,"profile9_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa10,"profile10_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa11,"profile11_fernando_pam_12K.csv", row.names = FALSE)
write.csv(aa12,"profile12_fernando_pam_12K.csv", row.names = FALSE)
write.csv(pam.res$clustering, "cluster_fernando_pam_12K.csv", row.names = FALSE)
