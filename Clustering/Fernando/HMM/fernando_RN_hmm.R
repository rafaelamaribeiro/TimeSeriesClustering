...
write.csv(vector_log_aic, "log_aic_fernando.csv")
write.csv(vector_log_bic, "log_bic_fernando.csv")
...
df
write.csv(df,"porMes_fernando_hmm.csv", row.names = FALSE)
write.csv(aa1,"profile1_fernando_hmm.csv", row.names = FALSE)
write.csv(aa2,"profile2_fernando_hmm.csv", row.names = FALSE)
write.csv(aa3,"profile3_fernando_hmm.csv", row.names = FALSE)
write.csv(aa4,"profile4_fernando_hmm.csv", row.names = FALSE)
write.csv(aa5,"profile5_fernando_hmm.csv", row.names = FALSE)
write.csv(aa6,"profile6_fernando_hmm.csv", row.names = FALSE)
write.csv(aa7,"profile7_fernando_hmm.csv", row.names = FALSE)
write.csv(aa8,"profile8_fernando_hmm.csv", row.names = FALSE)
write.csv(aa9,"profile9_fernando_hmm.csv", row.names = FALSE)
write.csv(aa10,"profile10_fernando_hmm.csv", row.names = FALSE)
write.csv(aa11,"profile11_fernando_hmm.csv", row.names = FALSE)
write.csv(aa12,"profile12_fernando_hmm.csv", row.names = FALSE)
write.csv(clust$clustering, "cluster.csv", row.names = FALSE)
