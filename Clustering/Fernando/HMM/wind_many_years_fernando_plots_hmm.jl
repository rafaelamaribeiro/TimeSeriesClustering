...
aa1 = CSV.read("profile1_fernando_hmm_2K.csv", DataFrame)
aa2 = CSV.read("profile2_fernando_hmm_2K.csv", DataFrame)
aa3 = CSV.read("profile3_fernando_hmm.csv", DataFrame)
aa4 = CSV.read("profile4_fernando_hmm.csv", DataFrame)
aa5 = CSV.read("profile5_fernando_hmm.csv", DataFrame)
aa6 = CSV.read("profile6_fernando_hmm.csv", DataFrame)
aa7 = CSV.read("profile7_fernando_hmm.csv", DataFrame)
aa8 = CSV.read("profile8_fernando_hmm.csv", DataFrame)
aa9 = CSV.read("profile9_fernando_hmm.csv", DataFrame)
aa10 = CSV.read("profile10_fernando_hmm.csv", DataFrame)
#aa11 = CSV.read("profile11_fernando_hmm.csv", DataFrame)
#aa12 = CSV.read("profile12_fernando_hmm.csv", DataFrame)

df_por_mes = CSV.read("porMes_fernando_hmm_2K.csv", DataFrame)

cluster = CSV.read("cluster_fernando_hmm_2K.csv", DataFrame)
cluster = cluster.x
...
savefig(plot1, "K12-K1-fernando-wind-hmm.png")
savefig(plot2, "K12-K2-fernando-wind-hmm.png")
savefig(plot3, "K12-K3-fernando-wind-hmm.png")
savefig(plot4, "K12-K4-fernando-wind-hmm.png")
savefig(plot5, "K12-K5-fernando-wind-hmm.png")
savefig(plot6, "K12-K6-fernando-wind-hmm.png")
savefig(plot7, "K12-K7-fernando-wind-hmm.png")
savefig(plot8, "K12-K8-fernando-wind-hmm.png")
savefig(plot9, "K12-K9-fernando-wind-hmm.png")
savefig(plot10, "K12-K10-fernando-wind-hmm.png")
savefig(plot11, "K12-K11-fernando-wind-hmm.png")
savefig(plot12, "K12-K12-fernando-wind-hmm.png")
