...
#dates <- unique(janauba$dates_new2)
#tail(dates)
...
df
write.csv(df,"porMes_janauba_pam_3K.csv", row.names = FALSE)
write.csv(aa1,"profile1_janauba_pam_3K.csv", row.names = FALSE)
write.csv(aa2,"profile2_janauba_pam_3K.csv", row.names = FALSE)
write.csv(aa3,"profile3_janauba_pam_3K.csv", row.names = FALSE)
write.csv(aa4,"profile4_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa5,"profile5_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa6,"profile6_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa7,"profile7_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa8,"profile8_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa9,"profile9_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa10,"profile10_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa11,"profile11_janauba_pam_12K.csv", row.names = FALSE)
write.csv(aa12,"profile12_janauba_pam_12K.csv", row.names = FALSE)
write.csv(pam.res$clustering, "cluster_janauba_pam_3K.csv", row.names = FALSE)
