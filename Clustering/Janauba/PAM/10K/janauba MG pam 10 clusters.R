...
PlotapodiBoxplot <- ggplot(janauba_pos, 
...
df
write.csv(df,"porMes_janauba.csv", row.names = FALSE)
write.csv(aa1,"profile1_janauba.csv", row.names = FALSE)
write.csv(aa2,"profile2_janauba.csv", row.names = FALSE)
write.csv(aa3,"profile3_janauba.csv", row.names = FALSE)
write.csv(aa4,"profile4_janauba.csv", row.names = FALSE)
write.csv(aa5,"profile5_janauba.csv", row.names = FALSE)
write.csv(aa6,"profile6_janauba.csv", row.names = FALSE)
write.csv(aa7,"profile7_janauba.csv", row.names = FALSE)
write.csv(aa8,"profile8_janauba.csv", row.names = FALSE)
write.csv(aa9,"profile9_janauba.csv", row.names = FALSE)
write.csv(aa10,"profile10_janauba.csv", row.names = FALSE)
