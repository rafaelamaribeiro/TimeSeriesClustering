...
#cd("/home/rafaela/Documents/PUC/IC/Global Horizontal Irradaytion/dados/Janauba/")
path = pwd()

janauba = CSV.read("JANAUBA_MG_UCT.csv", DataFrame)
janauba = janauba[1:359160,:]

#janaubaHourSolall.local_time = Date.(janaubaHourSolall.local_time, "yyy-mm-dd H:M")

#Sol = @df janaubaHourSolall plot(:local_time, :wind_speed, title = "Global Horizontal Irradaytion in Alegria 1 e 2 Wind Farms - RN", 
#xlab = "Hours", ylab = "Global Horizontal Irradaytion (Wh/m²)", legend = :outerbottomright, label = "a")

#savefig(Sol, "Sol_all_anos_janauba.png")
...
aa1 = CSV.read("profile1_janauba.csv", DataFrame)
aa2 = CSV.read("profile2_janauba.csv", DataFrame)
aa3 = CSV.read("profile3_janauba.csv", DataFrame)
aa4 = CSV.read("profile4_janauba.csv", DataFrame)
aa5 = CSV.read("profile5_janauba.csv", DataFrame)
aa6 = CSV.read("profile6_janauba.csv", DataFrame)
aa7 = CSV.read("profile7_janauba.csv", DataFrame)
aa8 = CSV.read("profile8_janauba.csv", DataFrame)
aa9 = CSV.read("profile9_janauba.csv", DataFrame)
aa10 = CSV.read("profile10_janauba.csv", DataFrame)

df_por_mes = CSV.read("porMes_janauba.csv", DataFrame)

cluster = CSV.read("cluster.csv", DataFrame)
cluster = cluster.x

#janauba_3anos = vcat(janaubaHourSol_2017)#, janaubaHourSol_2018, janaubaHourSol_2019)

#plotMedoids = scatter(janauba_3anos.wind_speed, marker_z = cor.color, legend = false, title = "3 clusters Janauba Nova", ylims = (0,16))

#savefig(plotMedoids, "Janauba-10k-medoids-scatter-Sol-all-anos")
...
savefig(plot1, "K10-K1-Janauba-Sol.png")
savefig(plot2, "K10-K2-Janauba-Sol.png")
savefig(plot3, "K10-K3-Janauba-Sol.png")
savefig(plot4, "K10-K4-Janauba-Sol.png")
savefig(plot5, "K10-K5-Janauba-Sol.png")
savefig(plot6, "K10-K6-Janauba-Sol.png")
savefig(plot7, "K10-K7-Janauba-Sol.png")
savefig(plot8, "K10-K8-Janauba-Sol.png")
savefig(plot9, "K10-K9-Janauba-Sol.png")
savefig(plot10, "K10-K10-Janauba-Sol.png")
...
@df janaubaHourSolall plot(:local_time, :wind_speed, title = "Global Horizontal Irradaytion in Janauba Solar Farm - CE", 
xlab = "Hours", ylab = "Global Horizontal Irradaytion (Wh/m²)", legend = :outerbottomright, label = "Original Data")
janaubaHourSolall.cluster = v3
Sol = @df janaubaHourSolall plot!(:local_time, :cluster, label = "Selected days")
...
dates = Vector(janaubaHourSolall.local_time)
...
tail(janaubaHourSolall)
head(janaubaHourSolall)
janaubaHourSolall.wind_speed

janaubaHourSolall.YR = Dates.year.(janaubaHourSolall.local_time)
janaubaHourSolall.MON = Dates.month.(janaubaHourSolall.local_time)

Vetor = zeros(length(janaubaHourSolall.local_time))

for i in 1:length(janaubaHourSolall.wind_speed)
  Vetor[i] = janaubaHourSolall.wind_speed[length(janaubaHourSolall.wind_speed)+1-i]
end

#vec = Vetor

num_years = length(unique(janaubaHourSolall.YR))
num_month = length(unique(janaubaHourSolall.MON))
...
month12_2010 = 0
month12_2010_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2010
        if janaubaHourSolall.MON[i] == 1
            month1_2010 = month1_2010 + janaubaHourSolall.wind_speed[i]
            month1_2010_n = month1_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2010 = month2_2010 + janaubaHourSolall.wind_speed[i]
            month2_2010_n = month2_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2010 = month3_2010 + janaubaHourSolall.wind_speed[i]
            month3_2010_n = month3_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2010 = month4_2010 + janaubaHourSolall.wind_speed[i]
            month4_2010_n = month4_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2010 = month5_2010 + janaubaHourSolall.wind_speed[i]
            month5_2010_n = month5_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2010 = month6_2010 + janaubaHourSolall.wind_speed[i]
            month6_2010_n = month6_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2010 = month7_2010 + janaubaHourSolall.wind_speed[i]
            month7_2010_n = month7_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2010 = month8_2010 + janaubaHourSolall.wind_speed[i]
            month8_2010_n = month8_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2010 = month9_2010 + janaubaHourSolall.wind_speed[i]
            month9_2010_n = month9_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2010 = month10_2010 + janaubaHourSolall.wind_speed[i]
            month10_2010_n = month10_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2010 = month11_2010 + janaubaHourSolall.wind_speed[i]
            month11_2010_n = month11_2010_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2010 = month12_2010 + janaubaHourSolall.wind_speed[i]
...
month12_2011_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2011
        if janaubaHourSolall.MON[i] == 1
            month1_2011 = month1_2011 + janaubaHourSolall.wind_speed[i]
            month1_2011_n = month1_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2011 = month2_2011 + janaubaHourSolall.wind_speed[i]
            month2_2011_n = month2_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2011 = month3_2011 + janaubaHourSolall.wind_speed[i]
            month3_2011_n = month3_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2011 = month4_2011 + janaubaHourSolall.wind_speed[i]
            month4_2011_n = month4_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2011 = month5_2011 + janaubaHourSolall.wind_speed[i]
            month5_2011_n = month5_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2011 = month6_2011 + janaubaHourSolall.wind_speed[i]
            month6_2011_n = month6_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2011 = month7_2011 + janaubaHourSolall.wind_speed[i]
            month7_2011_n = month7_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2011 = month8_2011 + janaubaHourSolall.wind_speed[i]
            month8_2011_n = month8_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2011 = month9_2011 + janaubaHourSolall.wind_speed[i]
            month9_2011_n = month9_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2011 = month10_2011 + janaubaHourSolall.wind_speed[i]
            month10_2011_n = month10_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2011 = month11_2011 + janaubaHourSolall.wind_speed[i]
            month11_2011_n = month11_2011_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2011 = month12_2011 + janaubaHourSolall.wind_speed[i]
...
month12_2012_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2012
        if janaubaHourSolall.MON[i] == 1
            month1_2012 = month1_2012 + janaubaHourSolall.wind_speed[i]
            month1_2012_n = month1_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2012 = month2_2012 + janaubaHourSolall.wind_speed[i]
            month2_2012_n = month2_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2012 = month3_2012 + janaubaHourSolall.wind_speed[i]
            month3_2012_n = month3_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2012 = month4_2012 + janaubaHourSolall.wind_speed[i]
            month4_2012_n = month4_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2012 = month5_2012 + janaubaHourSolall.wind_speed[i]
            month5_2012_n = month5_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2012 = month6_2012 + janaubaHourSolall.wind_speed[i]
            month6_2012_n = month6_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2012 = month7_2012 + janaubaHourSolall.wind_speed[i]
            month7_2012_n = month7_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2012 = month8_2012 + janaubaHourSolall.wind_speed[i]
            month8_2012_n = month8_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2012 = month9_2012 + janaubaHourSolall.wind_speed[i]
            month9_2012_n = month9_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2012 = month10_2012 + janaubaHourSolall.wind_speed[i]
            month10_2012_n = month10_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2012 = month11_2012 + janaubaHourSolall.wind_speed[i]
            month11_2012_n = month11_2012_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2012 = month12_2012 + janaubaHourSolall.wind_speed[i]
...
month12_2013_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2013
        if janaubaHourSolall.MON[i] == 1
            month1_2013 = month1_2013 + janaubaHourSolall.wind_speed[i]
            month1_2013_n = month1_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2013 = month2_2013 + janaubaHourSolall.wind_speed[i]
            month2_2013_n = month2_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2013 = month3_2013 + janaubaHourSolall.wind_speed[i]
            month3_2013_n = month3_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2013 = month4_2013 + janaubaHourSolall.wind_speed[i]
            month4_2013_n = month4_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2013 = month5_2013 + janaubaHourSolall.wind_speed[i]
            month5_2013_n = month5_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2013 = month6_2013 + janaubaHourSolall.wind_speed[i]
            month6_2013_n = month6_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2013 = month7_2013 + janaubaHourSolall.wind_speed[i]
            month7_2013_n = month7_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2013 = month8_2013 + janaubaHourSolall.wind_speed[i]
            month8_2013_n = month8_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2013 = month9_2013 + janaubaHourSolall.wind_speed[i]
            month9_2013_n = month9_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2013 = month10_2013 + janaubaHourSolall.wind_speed[i]
            month10_2013_n = month10_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2013 = month11_2013 + janaubaHourSolall.wind_speed[i]
            month11_2013_n = month11_2013_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2013 = month12_2013 + janaubaHourSolall.wind_speed[i]
...
month12_2014_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2014
        if janaubaHourSolall.MON[i] == 1
            month1_2014 = month1_2014 + janaubaHourSolall.wind_speed[i]
            month1_2014_n = month1_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2014 = month2_2014 + janaubaHourSolall.wind_speed[i]
            month2_2014_n = month2_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2014 = month3_2014 + janaubaHourSolall.wind_speed[i]
            month3_2014_n = month3_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2014 = month4_2014 + janaubaHourSolall.wind_speed[i]
            month4_2014_n = month4_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2014 = month5_2014 + janaubaHourSolall.wind_speed[i]
            month5_2014_n = month5_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2014 = month6_2014 + janaubaHourSolall.wind_speed[i]
            month6_2014_n = month6_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2014 = month7_2014 + janaubaHourSolall.wind_speed[i]
            month7_2014_n = month7_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2014 = month8_2014 + janaubaHourSolall.wind_speed[i]
            month8_2014_n = month8_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2014 = month9_2014 + janaubaHourSolall.wind_speed[i]
            month9_2014_n = month9_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2014 = month10_2014 + janaubaHourSolall.wind_speed[i]
            month10_2014_n = month10_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2014 = month11_2014 + janaubaHourSolall.wind_speed[i]
            month11_2014_n = month11_2014_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2014 = month12_2014 + janaubaHourSolall.wind_speed[i]
...
month12_2015_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2015
        if janaubaHourSolall.MON[i] == 1
            month1_2015 = month1_2015 + janaubaHourSolall.wind_speed[i]
            month1_2015_n = month1_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2015 = month2_2015 + janaubaHourSolall.wind_speed[i]
            month2_2015_n = month2_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2015 = month3_2015 + janaubaHourSolall.wind_speed[i]
            month3_2015_n = month3_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2015 = month4_2015 + janaubaHourSolall.wind_speed[i]
            month4_2015_n = month4_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2015 = month5_2015 + janaubaHourSolall.wind_speed[i]
            month5_2015_n = month5_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2015 = month6_2015 + janaubaHourSolall.wind_speed[i]
            month6_2015_n = month6_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2015 = month7_2015 + janaubaHourSolall.wind_speed[i]
            month7_2015_n = month7_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2015 = month8_2015 + janaubaHourSolall.wind_speed[i]
            month8_2015_n = month8_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2015 = month9_2015 + janaubaHourSolall.wind_speed[i]
            month9_2015_n = month9_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2015 = month10_2015 + janaubaHourSolall.wind_speed[i]
            month10_2015_n = month10_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2015 = month11_2015 + janaubaHourSolall.wind_speed[i]
            month11_2015_n = month11_2015_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2015 = month12_2015 + janaubaHourSolall.wind_speed[i]
...
month12_2016_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2016
        if janaubaHourSolall.MON[i] == 1
            month1_2016 = month1_2016 + janaubaHourSolall.wind_speed[i]
            month1_2016_n = month1_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2016 = month2_2016 + janaubaHourSolall.wind_speed[i]
            month2_2016_n = month2_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2016 = month3_2016 + janaubaHourSolall.wind_speed[i]
            month3_2016_n = month3_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2016 = month4_2016 + janaubaHourSolall.wind_speed[i]
            month4_2016_n = month4_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2016 = month5_2016 + janaubaHourSolall.wind_speed[i]
            month5_2016_n = month5_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2016 = month6_2016 + janaubaHourSolall.wind_speed[i]
            month6_2016_n = month6_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2016 = month7_2016 + janaubaHourSolall.wind_speed[i]
            month7_2016_n = month7_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2016 = month8_2016 + janaubaHourSolall.wind_speed[i]
            month8_2016_n = month8_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2016 = month9_2016 + janaubaHourSolall.wind_speed[i]
            month9_2016_n = month9_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2016 = month10_2016 + janaubaHourSolall.wind_speed[i]
            month10_2016_n = month10_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2016 = month11_2016 + janaubaHourSolall.wind_speed[i]
            month11_2016_n = month11_2016_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2016 = month12_2016 + janaubaHourSolall.wind_speed[i]
...
month12_2017_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2017
        if janaubaHourSolall.MON[i] == 1
            month1_2017 = month1_2017 + janaubaHourSolall.wind_speed[i]
            month1_2017_n = month1_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2017 = month2_2017 + janaubaHourSolall.wind_speed[i]
            month2_2017_n = month2_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2017 = month3_2017 + janaubaHourSolall.wind_speed[i]
            month3_2017_n = month3_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2017 = month4_2017 + janaubaHourSolall.wind_speed[i]
            month4_2017_n = month4_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2017 = month5_2017 + janaubaHourSolall.wind_speed[i]
            month5_2017_n = month5_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2017 = month6_2017 + janaubaHourSolall.wind_speed[i]
            month6_2017_n = month6_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2017 = month7_2017 + janaubaHourSolall.wind_speed[i]
            month7_2017_n = month7_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2017 = month8_2017 + janaubaHourSolall.wind_speed[i]
            month8_2017_n = month8_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2017 = month9_2017 + janaubaHourSolall.wind_speed[i]
            month9_2017_n = month9_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2017 = month10_2017 + janaubaHourSolall.wind_speed[i]
            month10_2017_n = month10_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2017 = month11_2017 + janaubaHourSolall.wind_speed[i]
            month11_2017_n = month11_2017_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2017 = month12_2017 + janaubaHourSolall.wind_speed[i]
...
month12_2018_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2018
        if janaubaHourSolall.MON[i] == 1
            month1_2018 = month1_2018 + janaubaHourSolall.wind_speed[i]
            month1_2018_n = month1_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2018 = month2_2018 + janaubaHourSolall.wind_speed[i]
            month2_2018_n = month2_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2018 = month3_2018 + janaubaHourSolall.wind_speed[i]
            month3_2018_n = month3_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2018 = month4_2018 + janaubaHourSolall.wind_speed[i]
            month4_2018_n = month4_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2018 = month5_2018 + janaubaHourSolall.wind_speed[i]
            month5_2018_n = month5_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2018 = month6_2018 + janaubaHourSolall.wind_speed[i]
            month6_2018_n = month6_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2018 = month7_2018 + janaubaHourSolall.wind_speed[i]
            month7_2018_n = month7_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2018 = month8_2018 + janaubaHourSolall.wind_speed[i]
            month8_2018_n = month8_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2018 = month9_2018 + janaubaHourSolall.wind_speed[i]
            month9_2018_n = month9_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2018 = month10_2018 + janaubaHourSolall.wind_speed[i]
            month10_2018_n = month10_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2018 = month11_2018 + janaubaHourSolall.wind_speed[i]
            month11_2018_n = month11_2018_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2018 = month12_2018 + janaubaHourSolall.wind_speed[i]
...
month12_2019_n = 0
for i in 1:length(janaubaHourSolall.YR)
    if janaubaHourSolall.YR[i] == 2019
        if janaubaHourSolall.MON[i] == 1
            month1_2019 = month1_2019 + janaubaHourSolall.wind_speed[i]
            month1_2019_n = month1_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 2
            month2_2019 = month2_2019 + janaubaHourSolall.wind_speed[i]
            month2_2019_n = month2_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 3
            month3_2019 = month3_2019 + janaubaHourSolall.wind_speed[i]
            month3_2019_n = month3_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 4
            month4_2019 = month4_2019 + janaubaHourSolall.wind_speed[i]
            month4_2019_n = month4_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 5
            month5_2019 = month5_2019 + janaubaHourSolall.wind_speed[i]
            month5_2019_n = month5_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 6
            month6_2019 = month6_2019 + janaubaHourSolall.wind_speed[i]
            month6_2019_n = month6_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 7
            month7_2019 = month7_2019 + janaubaHourSolall.wind_speed[i]
            month7_2019_n = month7_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 8
            month8_2019 = month8_2019 + janaubaHourSolall.wind_speed[i]
            month8_2019_n = month8_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 9
            month9_2019 = month9_2019 + janaubaHourSolall.wind_speed[i]
            month9_2019_n = month9_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 10
            month10_2019 = month10_2019 + janaubaHourSolall.wind_speed[i]
            month10_2019_n = month10_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 11
            month11_2019 = month11_2019 + janaubaHourSolall.wind_speed[i]
            month11_2019_n = month11_2019_n + 1
        elseif janaubaHourSolall.MON[i] == 12
            month12_2019 = month12_2019 + janaubaHourSolall.wind_speed[i]
...
plot2 = @df janaubaHourSolall plot(m', title = "Mean speed by years in Alegria 1 e 2 - RN", 
...
dates = janaubaHourSolall.local_time
intervalo_dates = dates[1:15000:length(dates)]

graf = plot(dates, janaubaHourSolall.wind_speed, xlabel = "Hours", ylabel = "Global Horizontal Irradaytion (Wh/m²)", 
title = "Power Generation in Alegria 1 and 2 Wind Farms - RN", label = "Original", 
xticks = (intervalo_dates))

T = length(janaubaHourSolall.wind_speed)

y = Vector(janaubaHourSolall.wind_speed)

hp = HP(y, 10_000_000_000)

grafQua10000000000 = plot(dates, janaubaHourSolall.wind_speed, xlabel = "Hours", 
