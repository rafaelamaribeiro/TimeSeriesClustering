...
aa1 = CSV.read("profile1_janauba_k_means_3K.csv", DataFrame)
aa2 = CSV.read("profile2_janauba_k_means_3K.csv", DataFrame)
aa3 = CSV.read("profile3_janauba_k_means_3K.csv", DataFrame)

#df_por_mes = CSV.read("porMes_janauba_k_means_3K.csv", DataFrame)

#cluster = CSV.read("cluster_janauba_k_means_3K.csv", DataFrame)
#cluster = cluster.x
...
savefig(plot1, "K3-K1-janauba-sol-k_means.png")
savefig(plot2, "K3-K2-janauba-sol-k_means.png")
savefig(plot3, "K3-K3-janauba-sol-k_means.png")
