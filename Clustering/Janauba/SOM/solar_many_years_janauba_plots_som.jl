...
cluster1 = CSV.read("janauba_clust1_som_12K_16n.csv", DataFrame)
cluster1 = cluster1.x
cluster2 = CSV.read("janauba_clust2_som_12K_16n.csv", DataFrame)
cluster2 = cluster2.x
cluster3 = CSV.read("janauba_clust3_som_12K_16n.csv", DataFrame)
cluster3 = cluster3.x
cluster4 = CSV.read("janauba_clust4_som_12K_16n.csv", DataFrame)
cluster4 = cluster4.x
cluster5 = CSV.read("janauba_clust5_som_12K_16n.csv", DataFrame)
cluster5 = cluster5.x
cluster6 = CSV.read("janauba_clust6_som_12K_16n.csv", DataFrame)
cluster6 = cluster6.x
cluster7 = CSV.read("janauba_clust7_som_12K_16n.csv", DataFrame)
cluster7 = cluster7.x
cluster8 = CSV.read("janauba_clust8_som_12K_16n.csv", DataFrame)
cluster8 = cluster8.x
cluster9 = CSV.read("janauba_clust9_som_12K_16n.csv", DataFrame)
cluster9 = cluster9.x
cluster10 = CSV.read("janauba_clust10_som_12K_16n.csv", DataFrame)
cluster10 = cluster10.x
cluster11 = CSV.read("janauba_clust11_som_12K_16n.csv", DataFrame)
cluster11 = cluster11.x
cluster12 = CSV.read("janauba_clust12_som_12K_16n.csv", DataFrame)
...
plot(aa4', title = "Cluster 4", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa5', title = "Cluster 5", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa6', title = "Cluster 6", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa7', title = "Cluster 7", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa8', title = "Cluster 8", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa9', title = "Cluster 9", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa10', title = "Cluster 10", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa11', title = "Cluster 11", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
plot(aa12', title = "Cluster 12", xlims = (1, 24), ylims = (0,1200), xticks = 0:1:24, xlab = "Hours", 
ylab = "Global Horizontal Irradayrion (Wh/m²)", legend = false, palette = :Blues_3)
...
savefig(plot1, "K12-K1-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot2, "K12-K2-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot3, "K12-K3-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot4, "K12-K4-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot5, "K12-K5-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot6, "K12-K6-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot7, "K12-K7-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot8, "K12-K8-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot9, "K12-K9-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot10, "K12-K10-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot11, "K12-K11-janauba-sol-som-16n-boxplot-lines.png")
savefig(plot12, "K12-K12-janauba-sol-som-16n-boxplot-lines.png")
