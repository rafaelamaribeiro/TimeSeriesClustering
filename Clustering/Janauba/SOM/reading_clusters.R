...
setwd("/home/rafaela/Documents/PUC/Artigos/Energy and AI/Artigo/Clustering/Janauba/SOM")
#setwd("C:\\Users\\Rafaela\\Downloads\\2022\\TFC\\codigos eol\\Janauba\\SOM")
...
write.csv(clust1, "janauba_clust1_som_12K_16n.csv")
write.csv(clust2, "janauba_clust2_som_12K_16n.csv")
write.csv(clust3, "janauba_clust3_som_12K_16n.csv")
write.csv(clust4, "janauba_clust4_som_12K_16n.csv")
write.csv(clust5, "janauba_clust5_som_12K_16n.csv")
write.csv(clust6, "janauba_clust6_som_12K_16n.csv")
write.csv(clust7, "janauba_clust7_som_12K_16n.csv")
write.csv(clust8, "janauba_clust8_som_12K_16n.csv")
write.csv(clust9, "janauba_clust9_som_12K_16n.csv")
write.csv(clust10, "janauba_clust10_som_12K_16n.csv")
write.csv(clust11, "janauba_clust11_som_12K_16n.csv")
write.csv(clust12, "janauba_clust12_som_12K_16n.csv")
...
write.csv(vec, "all_data_clus_som_12K_16n.csv")
