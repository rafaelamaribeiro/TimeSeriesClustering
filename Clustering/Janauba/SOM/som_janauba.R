...
som.cluster.k <- pam(som.events, k = 12, diss = FALSE)$cluster # pam
som.cluster.m <- pam(som.events, k = 12, diss = FALSE)$medoids # pam
...
write.csv(som.cluster.m, "som_medoids_12.csv")
