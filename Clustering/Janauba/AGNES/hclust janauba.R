...
janauba <- read.csv2("janauba_RN_UCT.csv")
...
df
write.csv(df,"porMes_janauba_agnes_3K.csv", row.names = FALSE)
write.csv(pam.res2, "cluster_janauba_agnes_3K.csv", row.names = FALSE)
