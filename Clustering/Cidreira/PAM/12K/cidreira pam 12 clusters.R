...
#cidreira$dates_new <- as.POSIXct(cidreira$dates_UCT, format = "%Y/%m/%d %H:%M")
...
#library(dplyr)
#cidreira_pos <- filter(cidreira, CIDREIRA_RS>0.1)
#length(cidreira_pos$CIDREIRA_RS)
...
df
write.csv(df,"porMes_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa1,"profile1_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa2,"profile2_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa3,"profile3_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa4,"profile4_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa5,"profile5_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa6,"profile6_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa7,"profile7_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa8,"profile8_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa9,"profile9_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa10,"profile10_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa11,"profile11_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(aa12,"profile12_cidreira_pam_12K.csv", row.names = FALSE)
write.csv(pam.res$clustering, "cluster_cidreira_pam_12K.csv", row.names = FALSE)
