...
#setwd("/home/rafaela/Documents/PUC/2022.1/TFC/codigos/Floresta")
setwd("C:\\Users\\Rafaela\\Downloads\\2022\\TFC\\codigos eol\\Floresta\\SOM")
...
write.csv(clust1, "floresta_clust1_som_12K_16n.csv")
write.csv(clust2, "floresta_clust2_som_12K_16n.csv")
write.csv(clust3, "floresta_clust3_som_12K_16n.csv")
write.csv(clust4, "floresta_clust4_som_12K_16n.csv")
write.csv(clust5, "floresta_clust5_som_12K_16n.csv")
write.csv(clust6, "floresta_clust6_som_12K_16n.csv")
write.csv(clust7, "floresta_clust7_som_12K_16n.csv")
write.csv(clust8, "floresta_clust8_som_12K_16n.csv")
write.csv(clust9, "floresta_clust9_som_12K_16n.csv")
write.csv(clust10, "floresta_clust10_som_12K_16n.csv")
write.csv(clust11, "floresta_clust11_som_12K_16n.csv")
write.csv(clust12, "floresta_clust12_som_12K_16n.csv")
...
write.csv(df,"porMes_floresta_som_12K_16n.csv", row.names = FALSE)
