...
df
write.csv(df,"porMes_floresta_k_means_3K.csv", row.names = FALSE)
write.csv(aa1,"profile1_floresta_k_means_3K.csv", row.names = FALSE)
write.csv(aa2,"profile2_floresta_k_means_3K.csv", row.names = FALSE)
write.csv(aa3,"profile3_floresta_k_means_3K.csv", row.names = FALSE)
write.csv(means.res$cluster, "cluster_floresta_k_means_3K.csv", row.names = FALSE)
