...
floresta <- read.csv2("floresta_CE_UCT.csv")
...
#floresta$dates_new2 <- as.Date(floresta$dates_UCT, format = "%Y/%m/%d")
...
#dates <- unique(floresta$dates_new2)
#tail(dates)
...
df
write.csv(df,"porMes_floresta_pam_3K.csv", row.names = FALSE)
write.csv(aa1,"profile1_floresta_pam_3K.csv", row.names = FALSE)
write.csv(aa2,"profile2_floresta_pam_3K.csv", row.names = FALSE)
write.csv(aa3,"profile3_floresta_pam_3K.csv", row.names = FALSE)
write.csv(aa4,"profile4_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa5,"profile5_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa6,"profile6_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa7,"profile7_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa8,"profile8_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa9,"profile9_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa10,"profile10_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa11,"profile11_floresta_pam_12K.csv", row.names = FALSE)
write.csv(aa12,"profile12_floresta_pam_12K.csv", row.names = FALSE)
write.csv(pam.res$clustering, "cluster_floresta_pam_3K.csv", row.names = FALSE)
