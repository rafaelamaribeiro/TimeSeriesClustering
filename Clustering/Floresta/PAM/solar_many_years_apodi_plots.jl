...
aa1 = CSV.read("profile1_floresta_pam_3K.csv", DataFrame)
aa2 = CSV.read("profile2_floresta_pam_3K.csv", DataFrame)
aa3 = CSV.read("profile3_floresta_pam_3K.csv", DataFrame)

df_por_mes = CSV.read("porMes_floresta_pam_3K.csv", DataFrame)

cluster = CSV.read("cluster_floresta_pam_3K.csv", DataFrame)
cluster = cluster.x
...
savefig(plot1, "K3-K1-floresta-sol-pam.png")
savefig(plot2, "K3-K2-floresta-sol-pam.png")
savefig(plot3, "K3-K3-floresta-sol-pam.png")
